...
from utils.mlflow_helpers import cleanup_old_mlflow_models
...
def train_models_from_consolidated_data(
    ...
    """
    from scripts.arima_standalone import (
        create_time_series_from_df,
        run_optuna_optimization,
        train_final_arima_model,
        evaluate_forecast
    )
    from scripts.modelling_prep import filter_book_data
        ...
        try:
            ...
            for i, params in enumerate(suggested_params):
                try:
                    ...
                    from scripts.arima_standalone import evaluate_forecast
            ...
            import optuna
            from scripts.arima_standalone import objective
            ...
            from scripts.arima_standalone import run_optuna_optimization_with_early_stopping
