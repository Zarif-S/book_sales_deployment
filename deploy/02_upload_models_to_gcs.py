...
Usage:
    ...
    python 02_upload_models_to_gcs.py --model-name arima_book_9780722532935
...
class ModelUploader:
    ...
    def download_model_from_mlflow(self, model_name: str, version: str = "latest") -> Optional[str]:
        """Download model from MLflow to temporary directory."""
        try:
            ...
            # Also save as regular pickle as backup
            pickle_model_path = os.path.join(temp_dir, "model.pkl")
...
'''
    ...
    def upload_all_models(self) -> Dict[str, str]:
        ...
        for model in models:
            ...
            logger.info(f"📦 Processing {model_name} v{version}")
