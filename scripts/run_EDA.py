...
def run_complete_analysis():
    ...
    if not df_beyond_2024.empty:
        ...
        display_plot(fig1, show=False)
        save_plot(fig1, "outputs/plots/interactive/weekly_volume_beyond_2024.html")
    ...
    display_plot(fig2_1, show=False)
    display_plot(fig2_2, show=False)
    save_plot(fig2_1, "outputs/plots/interactive/first_12_years_sales.html")
    save_plot(fig2_2, "outputs/plots/interactive/last_12_years_sales.html")
    ...
    if not selected_books_data.empty:
        ...
        display_plot(fig3, show=False)
        save_plot(fig3, "outputs/plots/interactive/selected_books_weekly.html")

    # Plot 4: Selected books yearly data
    if not selected_books_data.empty:
        fig4 = plot_selected_books_yearly(selected_books_data, isbn_to_title)
        display_plot(fig4, show=False)
        save_plot(fig4, "outputs/plots/interactive/selected_books_yearly.html")
    ...
    display_plot(fig5, show=False)
    save_plot(fig5, "outputs/plots/interactive/sales_trends_analysis.html")

    # Plot 6: Summary dashboard
    fig6 = create_summary_dashboard(df_processed, isbn_to_title)
    display_plot(fig6, show=False)
    save_plot(fig6, "outputs/plots/interactive/summary_dashboard.html")
...
def run_specific_analysis(analysis_type: str):
    ...
    if analysis_type == 'preprocessing':
        ...
        display_plot(fig2, show=False)
        save_plot(fig2, "outputs/plots/interactive/sales_trends_analysis.html")
        ...
        display_plot(fig1, show=False)
        display_plot(fig2, show=False)
        save_plot(fig1, "outputs/plots/interactive/first_12_years_sales.html")
        save_plot(fig2, "outputs/plots/interactive/last_12_years_sales.html")
...
def main():
    ...
    os.makedirs('outputs/plots/interactive', exist_ok=True)
    os.makedirs('outputs/plots/static', exist_ok=True)
